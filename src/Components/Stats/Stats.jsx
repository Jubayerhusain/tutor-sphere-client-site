...
function Stats() {
  ...
  return (
    <div className=" w-full 2xl:w-11/12 xl:w-11/12 lg:w-11/12 my-16 mx-auto py-6 grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-4 gap-6 max-h-screen overflow-hidden">
      {/* Tutors Count Card */}
